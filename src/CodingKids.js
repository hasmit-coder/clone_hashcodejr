            ...
            <div className="container">
                ...
                <div className="row form-group">
                    <div className="col-md-2">
                        <div id="fixedArrow"><ScrollTopArrow /></div>
                    </div>
                ...
                <div className="row form-group">
                    ...
                    <div className="col-md-12">
                        <Tabs>
                            <div className="" label="Jr Coder (Grade 1-2)">
                                <div className="row">
                                    <div className="col-md-3 form-group">
                                        <div className="card">
                                            <div className="card-header card_header_hcj text-white"><b></b>
                                            </div>
                            ...
                            <div label="Go Getter (Grade 3-5)">
                                <div className="row">
                                    <div className="col-md-3 form-group">
                                        <div className="card">
                                            <div className="card-header card_header_hcj text-white">
                                            </div>
                                            <div className="card-body card_body_hcj">
                                                <PricingIntro />
                                            </div>
                ...
                <div className = "row">
                    <div className="col-md-3">
                        {/* <a href="" target="_blank" className="btn btn_lejhro"> BLOG</a> */}
                        <Link className="link" target="_blank" to="/blog"><button className="btn btn_lejhro"><b>BLOG</b></button></Link>
                    </div>        
                </div>
                <br />
            </div>
